...
build_grobs <- function(i, alpha, colour, data, type = c("teams", "light_cap", "dark_cap", "scoreboard", "dot", "milb_logo", "milb_light_cap", "milb_dot", "logo_headshots", "gray_headshots", "dot_headshots", "milb_dot_headshots", "path")) {
  make_null <- FALSE
