...
Lastly, here are two examples using Baltimore Orioles data from Baseball Savant:
...
- Create a function that returns a dataframe with player ids and teams played for in a given year (maybe better for [baseballr](https://billpetti.github.io/baseballr/))
